...
import { Pill, Heart, Thermometer, Car, Droplet, Baby, Grid3X3 } from 'lucide-react';
        ...
        {categories.map((category) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-sm font-semibold leading-tight">{getCategoryName(category)}</span>
            </button>
          );
        })}
      </div>
