...
const CheckoutModal: React.FC<CheckoutModalProps> = ({
  ...
  const initialFormData: CheckoutFormData = useMemo(
    () => ({
  ...
  const initialPrescriptionData: PrescriptionFormData = useMemo(
    () => ({
  ...
  const [prescriptionData, setPrescriptionData] =
    useState<PrescriptionFormData>(initialPrescriptionData);
