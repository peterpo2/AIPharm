...
import { Shield, Award, Users, Clock, Heart, Stethoscope } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">{t('about.quality')}</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">{t('about.speed')}</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">{t('about.care')}</h3>
